  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
      ...
      <motion.div
        ...
        className="relative w-full max-w-4xl max-h-[90vh] bg-[#050508] border border-white/10 border-t-blue-500/40 shadow-[0_20px_60px_rgba(0,0,0,0.8)] rounded-3xl overflow-hidden flex flex-col"
      >
        <div className="p-8 border-b border-white/5 flex justify-between items-center bg-white/[0.01]">
          <div>
            ...
            <p className="text-[var(--text-dim)] text-xs font-bold uppercase tracking-widest mt-1">
              Linking Spare Parts to Digital Twin: <span className="text-blue-400">{machineName}</span>
            </p>
          </div>
          <button onClick={onClose} className="p-2 rounded-xl hover:bg-white/5 text-[var(--text-dim)] hover:text-white transition-all">
            <X className="w-6 h-6" />
          </button>
        </div>
            ...
            <div className="mb-6 space-y-4">
              ...
              <div className="relative">
                ...
                <input 
                  ...
                  className="w-full bg-black/40 border border-white/10 rounded-2xl pl-11 pr-4 py-3 text-sm text-white focus:outline-none focus:border-blue-500/50 outline-none transition-all shadow-inner"
                />
              </div>
            </div>
            ...
            <div className="space-y-2">
              {availableBlueprints.map(b => (
                <button
                  ...
                  className="w-full p-4 rounded-xl bg-white/[0.01] hover:bg-blue-500/10 border border-white/5 hover:border-blue-500/20 text-left transition-all group flex items-center justify-between"
                >
                  <div className="flex items-center gap-3">
                    <div className="w-8 h-8 rounded-lg bg-white/5 flex items-center justify-center text-[var(--text-dim)] group-hover:text-blue-400 transition-colors">
