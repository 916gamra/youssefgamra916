...
export function InventoryList() {
  ...
  return (
    ...
    >
      <motion.header variants={itemVariants} className="flex justify-between items-end mb-8">
        <div>
      ...
      <motion.div variants={itemVariants}>
        <GlassCard className="overflow-hidden">
          ...
          <div className="m-6 py-12 text-center text-slate-400 border border-dashed border-white/10 rounded-xl bg-white/[0.02]">
